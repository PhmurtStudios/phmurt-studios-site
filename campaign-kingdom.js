...
(function() {
  ...
  function initKingdom(name, rulerName) {
    return {
  ...
  function KingdomDashboard(_ref) {
    ...
    return React.createElement("div", null,
      ...
      React.createElement("div", { style: S.statRow },
        ...
        React.createElement(StatBadge, { label: "Treasury", value: kingdom.treasury + " BP", color: T.gold }),
  ...
  function KingdomView(_ref) {
    ...
    var handleCreate = useCallback(function(newKingdom) {
      setData(function(prev) { return Object.assign({}, prev, { kingdom: newKingdom }); });
    }, [setData]);
