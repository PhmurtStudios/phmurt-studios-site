...
MAP_NAME_POOL = [
    ...
    "BLOODMIRE", "ASHENMOOR", "WINDHOLLOW", "DAWNSPIRE", "CINDERFALL",
    # 41-50
    "NETHERVEIL", "GALENDRIS", "STORMVALE", "RUNEHEIM", "THORNGROVE",
    "DRAGONTIDE", "HALLOWED", "GREYWATCH", "EVERPEAK", "MISTRALUNE",
    # 51-60
    "IRONHOLD", "VALKENMOOR", "SERPENTIS", "DUSKREACH", "WOLFSBANE",
    "ARCANIUM", "FLAMECREST", "SHATTERED", "CROWNSGATE", "ELDENMARK",
    # 61-70
    "BLACKTHORN", "RAVENSHOLLOW", "SUNFORGE", "DEEPHOLM", "WYVERMERE",
    "GLOOMHAVEN", "SILVERPINE", "STONEWALL", "NIGHTFALL", "AURELIAN",
    # 71-80
    "GRIMSPIRE", "HAVENREACH", "EMBERGLOW", "FROSTHOLM", "DARKWATER",
    "HIGHCREST", "WILLOWMERE", "THUNDERCRAG", "ASHENSPIRE", "CRIMSONVALE",
    # 81-90
    "IRONMARCH", "ELDERGROVE", "STORMBORN", "DUSTHAVEN", "MOONFALL",
    "DREADMIRE", "GOLDENCREST", "WYVERNHOLDE", "STARFALL", "THORNHELM",
    # 91-100
    "AEGISHOLM", "SHADOWMERE", "BRIMSTONE", "GLACIERFORD", "OAKHAVEN",
    "DRAGONSPIRE", "BLEAKWIND", "SABLEWOOD", "DAWNHAMMER", "CRYSTALVEIL",
    # 101-110 (overflow buffer for future expansion)
    "NIGHTHOLLOW", "VALORMERE", "CINDERSPIRE", "TIDEWATCH", "IRONVALE",
    "KELDORAN", "ASHGROVE", "STORMHELM", "DARKSPIRE", "EMBERVALE",
]
...
def render_svg(cfg: AtlasConfig) -> str:
    ...
    # Deterministic: seed N gets MAP_NAME_POOL[N-1] so every seed 1-100+ is unique
    map_name = MAP_NAME_POOL[(cfg.seed - 1) % len(MAP_NAME_POOL)]
